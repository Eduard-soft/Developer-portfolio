...
const Nav = () => {
  ...
  return (
    ...
    gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0
     w-full xl:w-16 xl:max-w-md xl:h-screen'>
      ...
      xl:px-0 h-[80] xl:h-max py-8 bg-white/10 backdrop-blur-sm 
          ...
          return (
            ...
            >
              ...
              <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
                ...
                <div className='text-[12px] list-none font-semibold capitalize'>{link.name}
                </div>

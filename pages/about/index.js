    ...
    xl:flex-row gap-x-6">
      ...
      <motion.h2 
        ...
        <motion.div 
          ...
          {/* experience */}
          <div className="relative flex-1  after:h-full after:bg-white/10 
              after:absolute after:top-0 after:ring-0">
          ...
          <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 
              after:absolute after:top-0 after:ring-0">
            <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
              <CountUp start={0} end={25} duration={6}/> +
            </div>
            <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">
          ...
          <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 
              after:absolute after:top-0 after:ring-0">
            <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
              <CountUp start={0} end={78} duration={6}/> +
            </div>
            <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">
      ...
      {/* info */}
      <div className="flex flex-col w-full xl:max-w-[38%] h-[370px]">
